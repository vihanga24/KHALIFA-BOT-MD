...
exports.userLeveling = (levelRole) => {
	...
	exports.userXp = (jumlahXp) => {
	      ...
	      if (jumlahXp <= 50) {
				...
				return bars = `[█▒▒▒▒▒▒▒▒▒]`
			} else if (jumlahXp <= 200) {
				return bars = `[██▒▒▒▒▒▒▒▒]`
			} else if (jumlahXp <= 300) {
				return bars = `[███▒▒▒▒▒▒▒]`
			} else if (jumlahXp <= 400) {
				return bars = `[████▒▒▒▒▒▒]`
			} else if (jumlahXp <= 500) {
				return bars = `[█████▒▒▒▒▒]`
			} else if (jumlahXp <= 600) {
				return bars = `[██████▒▒▒▒]`
			} else if (jumlahXp <= 700) {
				return bars = `[███████▒▒▒]`
			} else if (jumlahXp <= 800) {
				return bars = `[████████▒▒]`
			} else if (jumlahXp <= 900) {
				return bars = `[█████████▒]`
			} else if (jumlahXp <= 1000) {
				return bars = `[██████████]`
			} else if (jumlahXp <= 10000) {
				return bars = `[██████████]`
			} 
	}
